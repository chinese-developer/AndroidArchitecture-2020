...
import com.example.architecture.home.ui.model.home.Song;
...
//        final String albumSongSortOrder = PreferencesUtility.getInstance(context).getAlbumSongSortOrder();
        ...
        return contentResolver.query(uri, new String[]{"_id", "title", "artist", "album", "duration", "track", "artist_id"}, string, null, /*albumSongSortOrder*/SortOrder.AlbumSongSortOrder.SONG_TRACK_LIST);
    }
}