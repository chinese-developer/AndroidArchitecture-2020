...
/**
 * This MultiState Layout contains the following these status [Content, Error/NetError/ServerError, Empty, and Loading/Request.]
 *
 * which you need to configure here [lib-base/res/values/base_styles.xml]
 *
 */
public class MultiStateLayout extends FrameLayout {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        int loadingViewResId = a.getResourceId(R.styleable.MultiStateLayout_msv_loadingView, -1);
        int requestingViewResId = a.getResourceId(R.styleable.MultiStateLayout_msv_requestingView, -1);
        int emptyViewResId = a.getResourceId(R.styleable.MultiStateLayout_msv_emptyView, -1);
        int errorViewResId = a.getResourceId(R.styleable.MultiStateLayout_msv_errorView, -1);
        int netErrorViewResId = a.getResourceId(R.styleable.MultiStateLayout_msv_net_errorView, -1);
        int serverErrorViewResId = a.getResourceId(R.styleable.MultiStateLayout_msv_server_errorView, -1);
        ...
        mDisableOperationWhenRequesting = a.getBoolean(R.styleable.MultiStateLayout_msv_disable_when_requesting, false);

        ensureInitState(a.getInt(R.styleable.MultiStateLayout_msv_viewState, CONTENT));
