...
import com.example.architecture.home.ui.model.home.Artist;
import com.example.architecture.home.utils.SortOrder;
...
//        final String artistSortOrder = PreferencesUtility.getInstance(context).getArtistSortOrder();
        Cursor cursor = context.getContentResolver().query(MediaStore.Audio.Artists.EXTERNAL_CONTENT_URI, new String[]{"_id", "artist", "number_of_albums", "number_of_tracks"}, selection, paramArrayOfString, /*artistSortOrder*/SortOrder.ArtistSortOrder.ARTIST_A_Z);
        return cursor;
    }
}
