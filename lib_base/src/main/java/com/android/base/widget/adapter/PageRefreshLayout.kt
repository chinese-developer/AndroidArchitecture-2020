...
import com.android.base.widget.adapter.listener.OnMultiStateListener
import com.android.base.widget.adapter.utils.bindingAdapter
import com.android.base.widget.statusLayout.StateConfig
import com.android.base.widget.statusLayout.StateLayout
import com.android.base.widget.statusLayout.Status
...
open class PageRefreshLayout : SmartRefreshLayout, OnRefreshLoadMoreListener {
     ...
     * 指定列表位置(倒序索引)显示自动预加载
     */
    var preloadIndex = Companion.preloadIndex
